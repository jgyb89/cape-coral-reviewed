...
export default function CcrCard({ listing }) {
  ...
  return (
    <Link href={listingUrl} className="ccr-card">
      <div className="ccr-card__image-container">
        ...
        <div className="ccr-card__avatar">
          <span className="material-symbols-outlined" style={{fontSize: '44px', color: '#ccc'}}>
            storefront
          </span>
        </div>
      </div>
      ...
      <div className="ccr-card__content">
        ...
        <div className="ccr-card__rating">
          ...
          <span style={{ color: '#666', fontSize: '0.8rem' }}>(12 reviews)</span>
        </div>
        ...
        <div className="ccr-card__footer">
          ...
          <button className="ccr-card__favorite" aria-label="Add to favorites" onClick={(e) => {
            e.preventDefault();
            // Favorite logic here
          }}>
