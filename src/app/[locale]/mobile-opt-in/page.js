...
export const metadata = {
  title: "Mobile Opt-In | Rockford Reviewed",
  description: "Sign up for SMS/MMS marketing and account alerts from Rockford Reviewed.",
};

export default function MobileOptInPage() {
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "4rem 2rem", textAlign: "center" }}>
      <h1 style={{ marginBottom: "1rem", color: "#333" }}>Sign Up for Rockford Reviewed Text Alerts</h1>
